...
```sql
INSERT ALL
    INTO Student04 (StudentNO, StudentName, StudentCollege, University, Address, Marks_FirstYear, Marks_SecondYear, Marks_FinalYear) 
    VALUES (401, 'Arjun', 'ABC College', 'XYZ University', '123 Street, City A', 350, 300, 320)
    
    INTO Student04 (StudentNO, StudentName, StudentCollege, University, Address, Marks_FirstYear, Marks_SecondYear, Marks_FinalYear) 
    VALUES (402, 'Neha', 'PQR College', 'XYZ University', '456 Street, City B', 460, 470, 495)
    
    INTO Student04 (StudentNO, StudentName, StudentCollege, University, Address, Marks_FirstYear, Marks_SecondYear, Marks_FinalYear) 
    VALUES (403, 'Rahul', 'LMN College', 'XYZ University', '789 Street, City C', 180, 150, 140)
    
    INTO Student04 (StudentNO, StudentName, StudentCollege, University, Address, Marks_FirstYear, Marks_SecondYear, Marks_FinalYear) 
    VALUES (404, 'Priya', 'ABC College', 'XYZ University', '321 Street, City D', 450, 400, 470)
    
    INTO Student04 (StudentNO, StudentName, StudentCollege, University, Address, Marks_FirstYear, Marks_SecondYear, Marks_FinalYear) 
    VALUES (405, 'Amit', 'PQR College', 'XYZ University', '654 Street, City E', 480, 490, 495)
SELECT * FROM DUAL;
```
<table border="1" cellpadding="10" cellspacing="0">
    <thead>
